      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-20 items-start">
        ...
        <div className="lg:col-span-1 flex flex-col justify-between h-full pt-2">
          <div className="values-heading">
            ...
            <p className="mt-6 text-sm text-white leading-relaxed max-w-xs">
              As Australia&apos;s trusted chemical partner, we combine decades of expertise with an unwavering commitment to integrity and quality.
            </p>
        ...
        <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
          {coreValues.map((item) => (
            <article
              key={item.id}
              className="values-card bg-white flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow duration-300 group"
            >
              <div>
              ...
              <div className="px-6 pb-6 pt-2 flex items-center justify-between">
                <time className="text-[11px] font-semibold text-slate-400 tracking-wider uppercase">
                  Learn More
                </time>
                <Link
                  href={item.link}
