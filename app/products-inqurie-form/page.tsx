...
const productsList = [
  ...
  "Trisodium Phosphate 5%", "Trisodium Phosphate 98%", "Urea", "Urea solution 20%", "Urea solution 50%",
  "Xylene Isomer"
];
...
export default function ProductInquiryForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!formData.fullName || !formData.company || !formData.email || !formData.phone || !formData.remarks || selectedProducts.length === 0) {
      alert('Please fill all required fields and select at least one product');
      return;
    }
    console.log({ selectedProducts, ...formData });
    alert('Inquiry submitted successfully! We will respond as soon as possible.');
    setFormData({ fullName: '', company: '', email: '', phone: '', remarks: '' });
    setSelectedProducts([]);
    setSearchTerm('');
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 text-white">
            Send us your <span className="text-red-400">requirement</span>
          </h1>
          <p className="text-white/70 text-lg max-w-2xl leading-relaxed">
            Select the products you need and complete the form below. We&apos;ll respond to your inquiry as soon as possible.
          </p>
        </div>
            ...
            <div className="p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-xs font-bold text-red-300 uppercase tracking-wider mb-2 block">Full Name *</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-bold text-red-300 uppercase tracking-wider mb-2 block">Company *</label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-xs font-bold text-red-300 uppercase tracking-wider mb-2 block">Email *</label>
                    <input
                      type="email"
                  ...
                  <div>
                    <label className="text-xs font-bold text-red-300 uppercase tracking-wider mb-2 block">Contact Number *</label>
                    <input
                      type="tel"
                ...
                {/* Remarks */}
                <div>
                  <label className="text-xs font-bold text-red-300 uppercase tracking-wider mb-2 block">Remarks / Comments *</label>
                  <textarea
                    rows={3}
            ...
            <div className="p-8 md:p-10 h-full flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 flex flex-col gap-2">
                ...
                {filteredProducts.length === 0 && (
                  <p className="text-sm text-white/50 p-4 text-center mt-8">No products found matching &quot;{searchTerm}&quot;</p>
                )}
              </div>
