...
export default function ProductsPage() {
  ...
  // Search logic filtering by name or category
  ...
  return (
    <main className="relative w-full min-h-screen bg-red-950 font-sans antialiased overflow-x-hidden m-0 p-0">

      {/* HERO SECTION */}
      <section className="w-full pt-32 pb-16 px-4 flex flex-col items-center text-center bg-red-950">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold max-w-5xl leading-[1.15] tracking-tight text-white mb-6">
          Pascom supplies high quality chemicals for the oil & gas, water
          treatment, agriculture, and mining industries.
        </h1>
        <p className="text-white/80 text-base md:text-lg max-w-2xl mb-8 font-medium">
          Focusing on innovative, reliable, and efficient solutions tailored to
          meet the highest industry standards.
        </p>

        <button className="flex items-center gap-3 bg-red-600 border border-red-500 rounded-full pl-6 pr-1.5 py-1.5 shadow-lg hover:shadow-xl hover:bg-red-700 transition-all duration-300 mb-20 group">
          <span className="text-sm font-bold text-white">
            View Full Catalog
          </span>
          <div className="w-8 h-8 rounded-full bg-white flex items-center justify-center text-red-600 group-hover:scale-110 transition-transform">
            <i className="fa-solid fa-arrow-right text-xs"></i>
          </div>
        </button>

        {/* 3D Curved Image Gallery */}
        <div className="relative w-full max-w-350 h-75 md:h-100 flex justify-center items-center mb-12" style={{ perspective: "1200px" }}>
          {/* Card 1 (Far Left) */}
          <div
            className="absolute w-[22%] h-[85%] rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500"
            style={{ transform: "rotateY(25deg) translateZ(-150px) translateX(-135%)" }}
          >
            <img src="https://pascom.com.au/wp-content/uploads/2024/06/pexels-umaraffan499-87236-768x512.jpg" alt="Oil & Gas" className="w-full h-full object-cover" />
          </div>

          {/* Card 2 (Mid Left) */}
          <div
            className="absolute w-[24%] h-[88%] rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500"
            style={{ transform: "rotateY(10deg) translateZ(-50px) translateX(-45%) scaleY(1.02)" }}
          >
            <img src="https://pascom.com.au/wp-content/uploads/2024/06/pexels-piotr-arnoldes-7862031-6109677-scaled.jpg" alt="Water Treatment" className="w-full h-full object-cover" />
          </div>
          ...
          <div
            ...
            style={{ transform: "rotateY(-10deg) translateZ(-50px) translateX(45%) scaleY(1.02)" }}
          >
            <img src="https://pascom.com.au/wp-content/uploads/2024/06/pexels-pixabay-432786-768x512.jpg" alt="Agriculture" className="w-full h-full object-cover" />
          </div>
          ...
          <div
            ...
            style={{ transform: "rotateY(-25deg) translateZ(-150px) translateX(135%)" }}
          >
            <img src="https://pascom.com.au/wp-content/uploads/2024/06/pexels-umaraffan499-87236-768x512.jpg" alt="Mining" className="w-full h-full object-cover" />
          </div>
        </div>

        {/* Gallery Labels */}
        <div className="hidden md:flex justify-center gap-16 lg:gap-32 w-full max-w-5xl mt-12">
          {["Oil & Gas", "Water Treatment", "Agriculture", "Mining"].map((label, i) => (
            <div key={i} className="text-center">
              <span className="text-red-600 font-bold text-sm block mb-2">0{i + 1}</span>
      ...
      <section className="bg-red-900/40 py-24 px-4 md:px-12 border-y border-red-700/50">
      ...
      <section className="w-full bg-red-950 py-24 px-4 md:px-12">
        <div className="max-w-375 mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-6">
            ...
            <div className="relative w-full md:w-80">
              <i className="fa-solid fa-magnifying-glass absolute left-4 top-1/2 -translate-y-1/2 text-red-300"></i>
              <input
                type="text"
                placeholder="Search chemicals or categories..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full bg-red-900/30 border border-red-700/50 text-white text-sm rounded-full pl-10 pr-4 py-3 outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all placeholder:text-white/50"
              />
            </div>
          </div>

          {/* Grid Layout matching the 'Services' premium card design */}
          ...
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product, index) => (
              <Link
                ...
                className="group relative block w-full h-115 shrink-0 overflow-hidden bg-red-900/40 border border-red-700/50 hover:border-red-500/80 transition-all duration-500 cursor-pointer"
              >

                {/* Background Image Container */}
                <div className="absolute inset-0 w-full h-[65%] overflow-hidden bg-black z-0">
                  <div className="w-[130%] h-full relative left-[-15%]">
                    <Image
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(to bottom, transparent 20%, rgba(153, 27, 27, 0.6) 60%, rgba(120, 29, 29, 0.8) 100%)`
                  }}
                ></div>
                ...
                <div className="absolute inset-0 z-20 flex flex-col p-6 md:p-8">
                  ...
                  <div className="flex justify-between items-start w-full">
                    <span className="bg-red-600/80 backdrop-blur-md border border-red-500/60 px-3 py-1.5 text-[10px] font-bold tracking-widest uppercase text-white shadow-sm rounded">
                      {product.cas_number ? `CAS: ${product.cas_number}` : product.category.split(' ')[0]}
                    </span>
                  ...
                  <div className="mt-auto">
                    <h3 className="text-2xl md:text-3xl font-semibold text-white leading-tight mb-3 tracking-tight">
                      {product.name}
                    </h3>
            ...
            <div className="col-span-full text-center py-16 text-white/60 font-medium">
