...
const productsList = [
  {
    ...
    description:
      "A highly concentrated solution of acetic acid, commonly used in industrial applications, chemical synthesis, and as a laboratory reagent.",
    cas_number: "64-19-7",
    concentration: "90%",
    ...
    safety_notes:
      "Corrosive. Causes severe burns. Keep cool and ventilated. Avoid strong bases and oxidizing agents. Wear chemical gloves and eye protection.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A quick-drying, alcohol-based product designed to kill germs and bacteria on the skin. Commonly used for hand hygiene when soap and water are not available.",
    ...
    safety_notes:
      "Flammable. Keep away from heat or flames. External use only. Use in well-ventilated spaces. Store below 30°C.",
    supplier: "Pascom",
    country: "Australia",
    features: [
  ...
  },
  {
    ...
    description:
      "A 5% aqueous solution of trisodium phosphate, widely used as a cleaning agent, degreaser, and food additive. Also serves as a buffering agent and emulsifier.",
    ...
    safety_notes:
      "Can irritate skin and eyes. Avoid inhaling dust. Harmful if swallowed. Store in a dry, cool spot away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Concentrated aqueous solutions of ammonia (ammonium hydroxide) in 10-30%, 19%, and 25% concentrations. Used in industrial cleaning, fertilizer production, and chemical synthesis.",
    ...
    safety_notes:
      "Corrosive and toxic. Use safety gear and ensure ventilation. Keep away from acids. Store in a cool, ventilated spot.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-purity crystalline compound used in glass etching, metal cleaning, and as a precursor in chemical synthesis. Highly corrosive and releases toxic fumes when heated.",
    ...
    safety_notes:
      "Corrosive. Releases toxic fumes when heated. Store in a cool, dry, well-ventilated space. Keep sealed.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A 3.5% solution of sodium tetraborate decahydrate used for its boron content in farming, cleaning, and manufacturing. Useful where accurate boron levels or mild cleaning power are needed.",
    ...
    safety_notes:
      "Wear gloves and goggles. Use in well-ventilated area. Store in a dry, cool place away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-purity, white crystalline substance used in de-icing, dust control, and various industrial applications. It is hygroscopic and effective in controlling humidity and melting ice.",
    ...
    safety_notes:
      "Can irritate skin and eyes. Use gloves and eye protection. Work in ventilated area. Store in cool, dry place sealed tightly. Reacts with water, generating heat.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A powerful disinfectant and bleaching agent used for water treatment, sanitation, and industrial cleaning. Effective in killing bacteria, viruses, and algae.",
    cas_number: "7778-54-3",
    available_grades: ["65%", "70%"],
    appearance:
      "White or greyish granules (65%) / White fine granules or powder (70%)",
    odor: "Chlorine smell",
    applications: [
    ...
    safety_notes:
      "Strong oxidizer. Keep dry, cool, and out of sunlight. Use appropriate PPE.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A highly caustic and versatile chemical used in various industrial processes, including the production of soap, paper, and detergents. Available in solid and liquid forms.",
    ...
    packaging: ["Bulk", "Custom packaging"],
    safety_notes:
      "Highly corrosive. Wear gloves, eye protection, and protective clothing. Store in a cool, dry place with good airflow. Keep away from acids and moisture.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Diluted aqueous solutions of sodium hydroxide in concentrations of 10%, 20%, 31.5%, 40%, and 50%. Used in water treatment, chemical production, food processing, and cleaning.",
    cas_number: "1310-73-2",
    ...
    concentration_details: {
      "10_percent": {
        ...
        industries: ["Water treatment", "Lab use"],
      },
      "20_percent": {
    ...
    safety_notes:
      "Corrosive. Use corrosion-resistant containers. Avoid skin and eye contact. Store in cool, dry place.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A bright yellow-green fluorescent dye used in leak detection, water tracing, and medical testing. Glows clearly under UV light, making it easy to track water or fluid flow.",
    ...
    safety_notes:
      "Low toxicity at normal use levels. Wear gloves, goggles, and mask to avoid dust. Store in a cool, dry place away from strong chemicals and light.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A crystalline, colorless compound used as a natural preservative, flavoring agent, and pH adjuster in food, beverages, cleaning products, and cosmetics.",
    ...
    safety_notes:
      "May irritate skin and eyes. Wear gloves and eye protection. Store in a cool, dry place away from strong oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "Diluted solutions of citric acid in 10% and 50% concentrations. Used in food production, cosmetics, pharmaceuticals, and water treatment for pH adjustment, preservation, and chelation.",
    cas_number: "77-92-9",
    ...
    "50_percent_solution": {
      ...
      solubility: "Dissolves fully in water",
      uses: [
        "Pharmaceutical pH adjustments",
        "Cleaning (scale removal)",
        "Water treatment (alkalinity neutralisation)",
        "Metal cleaning",
      ],
    },
    applications: [
  ...
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A concentrated solid form of potassium hydroxide (caustic potash) used in the production of soaps, detergents, and other industrial chemicals. Also used as an electrolyte in alkaline batteries and for pH adjustment.",
    ...
    packaging: ["Bulk", "Custom packaging"],
    safety_notes:
      "Causes severe burns. Wear chemical-resistant gloves, safety goggles, and protective clothing. Store cool and dry. Keep away from acids and aluminum. Use with good ventilation.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Food and Industrial Ingredients",
    description:
      "A water-free form of citric acid used as an acidulant, preservative, and pH regulator in food, pharmaceuticals, and industrial applications. Enhances flavor, stabilizes active ingredients, and improves solubility.",
    cas_number: "77-92-9",
    ...
    packaging: ["Bulk", "Custom packaging"],
    safety_notes:
      "May cause mild eye and skin irritation. Avoid dust inhalation. Use with adequate ventilation. Store in a cool, dry place away from moisture. Avoid strong alkalis and oxidizing agents.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A crystalline salt used in the production of pigments and batteries. Serves as a source of cobalt in chemical reactions and electroplating.",
    ...
    safety_notes:
      "Can irritate skin and eyes. Avoid breathing dust. Use protective gear (gloves, goggles, clothes). Work in ventilated area. Harmful if swallowed. Store in dry, cool place away from strong acids and oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A bright blue crystalline compound used in agriculture, chemistry, and as a fungicide. Also used for algae control and in various chemical processes.",
    ...
    safety_notes:
      "Wear gloves, goggles, and dust mask. Don't inhale dust. Store in a dry, cool place away from food and strong acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A UV-curable chemical used in industrial coatings and printing. Cures quickly under UV light to form a strong, smooth finish.",
    ...
    safety_notes:
      "Use gloves and eye protection. Keep work areas ventilated. Store away from UV light. Solvent-free.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "High-purity deionised water with all dissolved ions removed. Used in laboratory experiments, industrial processes, and applications requiring high-purity water.",
    ...
    safety_notes:
      "Not irritating. Not for drinking (no minerals). Store in clean, sealed containers away from dirt.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A concentrated solution of ethylenediaminetetraacetic acid used primarily as a chelating agent to bind metal ions and prevent their undesirable reactions in various applications.",
    cas_number: "64-02-8",
    concentration: "40%",
    ...
    safety_notes:
      "May cause mild irritation. Use gloves and eye protection. Work in well-ventilated area. Store in a cool, dry place away from strong oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
  ...
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Solutions of ferric sulfate used primarily in water treatment and as a coagulant in various industrial processes. Effective in purifying water and treating wastewater.",
    ...
    concentration_40_50_percent: {
      uses: [
        ...
        "Ore processing",
        "Paper making",
        "Heavy-duty wastewater",
      ],
      suitability: "Tough industrial applications",
    },
    packaging: ["Drums", "IBCs", "Tankers"],
    safety_notes:
      "Can cause irritation. Use protective equipment. Store in cool, ventilated area.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Tracer Dyes",
    description:
      "A fluorescent dye used to trace water flow, find leaks, and study how liquids move. The 40% concentration makes it easy to see, even when used in small amounts.",
    cas_number: "518-47-8",
    concentration: "40%",
    ...
    safety_notes:
      "Non-toxic but stains. Use gloves and eye protection. Work in ventilated space. Store in a cool, dark place away from strong chemicals.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A premium-grade, refined petroleum distillate with a high flash point, making it a safer alternative for various applications. Used as fuel for lamps, heaters, and certain engines, as well as a solvent and cleaning agent.",
    ...
    safety_notes:
      "Flammable (but higher flash point). Keep away from flames. Use gloves and safety glasses. Store in a cool, open area.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Acidic solutions used in various industrial and laboratory applications, including pH control and metal cleaning. Available in multiple concentrations.",
    ...
    concentration_details: {
      "5_percent": {
        uses: ["Labs", "Schools", "Light cleaning", "pH adjustments"],
      },
      "10_35_percent": {
        uses: ["Surface treatment", "pH control", "General processing"],
      },
      "15_percent": {
        uses: ["Water treatment", "Food industry (where approved)", "Lab work"],
      },
      ...
      "32_percent": {
        uses: ["Steel making", "Oil refining", "Large-scale water treatment"],
      },
    },
    packaging: ["IBCs", "Drums", "Custom sizes"],
    safety_notes:
      "Highly corrosive. Use corrosion-resistant containers. Store in cool, well-ventilated spot away from incompatible materials. Use appropriate PPE.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Clear, colorless aqueous solutions recognized for their potent oxidizing properties. Used as powerful bleaching agents, effective disinfectants, and essential components in numerous chemical synthesis processes.",
    ...
    concentration_50_percent: {
      uses: [
        ...
        "Chemical syntheses",
        "Heavy-duty environmental cleanup",
      ],
    },
    packaging: ["Drums", "IBCs", "Bulk tanks"],
    safety_notes:
      "Powerful oxidizer. Store in a cool, ventilated area away from heat, metals, and organic materials. Use appropriate PPE.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A clear, colorless liquid with a slightly sweet odor. Widely used as a solvent, antifreeze, and in the production of chemicals. Toxic nature requires careful handling.",
    cas_number: "67-56-1",
    ...
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Highly flammable and toxic. Can cause blindness or death if swallowed or inhaled. Use in well-ventilated area. Wear gloves and eye protection. Keep away from fire and heat.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Solvents",
    description:
      "A volatile, colorless liquid with a sweet smell. Used as a solvent in industrial processes, paint stripping, and as a laboratory reagent.",
    cas_number: "75-09-2",
    ...
    packaging: ["Drums", "IBCs"],
    safety_notes:
      "Flammable? No, but volatile with health risks. Use in well-ventilated areas. Wear gloves, eye protection, and respirator. Store cool and dry, away from sparks and strong oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A colorless, odorless liquid used as an antifreeze, coolant, and raw material in various industries. Mixes well with water and stays liquid in cold temperatures.",
    cas_number: "107-21-1",
    ...
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Harmful if swallowed in large amounts. Use gloves and eye protection. Work in ventilated space. Store in a cool, dry area away from heat and oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-purity form of monoethylene glycol used primarily in the production of synthetic fibers like polyester. Also used in PET plastics and textiles.",
    cas_number: "107-21-1",
    purity: "≥99.9%",
    appearance: "Clear, colourless liquid",
    odor: "Almost none",
    ...
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Use gloves, goggles, and protective clothes. Work in well-ventilated area. Store in a cool, dry place away from heat and strong chemicals. Harmful if swallowed in large amounts.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A concentrated chemical that helps remove oxygen from water and fluid systems. Contains 65% ammonium bisulfite with a small amount of nickel catalyst for faster reaction.",
    cas_number: "10102-40-6",
    concentration: "65%",
    ...
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Use gloves, eye protection, and ensure good airflow. Store in a cool, dry place away from heat and oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A white, crystalline salt used in fertilizers, medicine, and as a salt substitute. Provides potassium, an essential nutrient for plant growth and human health.",
    ...
    safety_notes:
      "Generally safe. Store in a cool, dry place away from moisture. Use sealed containers to prevent caking.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Concentrated solutions of potassium hydroxide (caustic potash) in 45% and 49% concentrations. Used in pharmaceuticals, water treatment, food production, soap making, and chemical processing.",
    cas_number: "1310-58-3",
    ...
    concentration_49_percent: {
      uses: [
        "Chemical synthesis",
        "Water treatment",
        "Demanding alkaline processes",
      ],
    },
    packaging: ["Small containers", "Bulk containers"],
    safety_notes:
      "Very caustic and corrosive. Wear proper protective equipment. Ensure good ventilation. Keep containers sealed to prevent moisture absorption.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A high-performance silicone-based defoamer for industrial use. Controls foam in water treatment, paper making, and chemical processes.",
    ...
    safety_notes:
      "Can irritate skin and eyes. Wear gloves and eye protection. Use in well-ventilated areas. Store in original containers in a cool, dry place away from sunlight and extreme temperatures.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A granular form of sodium carbonate used in glass manufacturing, water treatment, and chemical production. Effective in raising pH levels and acting as a cleaning agent.",
    cas_number: "497-19-8",
    ...
    safety_notes:
      "Can irritate skin and eyes. Wear gloves and eye protection. Avoid inhaling dust. Store in a dry, ventilated area away from acids and moisture.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A high-purity sodium carbonate that meets Food Chemicals Codex standards. Used in food processing, beverage production, and pharmaceuticals.",
    cas_number: "497-19-8",
    appearance: "White, crystalline powder or granular solid",
    odor: "No smell",
    solubility: "Dissolves easily in water",
    ...
    packaging: ["25kg bags", "Bulk containers"],
    safety_notes:
      "Can cause moderate irritation. Wear gloves, safety goggles, and protective clothing. Store in a cool, dry, ventilated area away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A white, crystalline powder used in various industrial processes including chemical synthesis, textile dyeing, and as a food preservative. The anhydrous form is more potent and lasts longer than hydrated versions.",
    cas_number: "127-09-3",
    ...
    safety_notes:
      "Generally safe. Use protective equipment and good ventilation. Store in a cool, dry place away from moisture, strong acids, and oxidizers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A white crystalline powder used as a pH buffer, in water treatment, food processing, pharmaceuticals, and manufacturing. Also known as baking soda.",
    cas_number: "144-55-8",
    ...
    safety_notes:
      "Generally safe. Use dust masks when handling fine powders. Store in a dry, cool place away from acids and moisture.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A sterile, isotonic buffer solution used in medical and industrial applications for pH control and alkalinity management. Pharmaceutical-grade 7.2% sodium bicarbonate in purified water.",
    cas_number: "144-55-8",
    ...
    safety_notes:
      "Medical use only under professional supervision. Monitor electrolyte levels during therapeutic use. Store at room temperature (15-25°C) in original container, protected from light.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Aqueous solutions of sodium bisulfite in 30% and 40% concentrations. Used as a reducing agent, preservative, and in water treatment processes.",
    ...
    concentration_40_percent: {
      uses: [
        "Pulp bleaching",
        "Heavy-duty oxygen scavenging",
        "Large-scale chlorine neutralization",
      ],
      industries: ["Paper manufacturing", "Industrial water treatment"],
    },
    packaging: ["Drums", "IBCs", "Bulk"],
    safety_notes:
      "Can cause irritation. Use protective equipment and ventilation. Store in a cool, dry place away from sunlight and incompatible materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-purity chemical used in photographic processes, water treatment, and oil drilling. The photo grade ensures low impurities for sensitive applications.",
    ...
    safety_notes:
      "Wear gloves, goggles, and protective clothing. Use in well-ventilated areas. Keep away from strong acids and oxidisers. Store in a dry, cool place.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "Solutions of sodium carbonate in 10% and 20% strengths. Used in cleaning products, water softening, and various industrial processes.",
    cas_number: "497-19-8",
    ...
    concentration_20_percent: {
      uses: [
        "Heavy-duty cleaning",
        "Stronger pH adjustment",
        "Boiler water treatment",
      ],
    },
    packaging: ["Bulk drums", "IBCs", "Custom amounts"],
    safety_notes:
      "Can be irritating. Store in a dry, cool place away from incompatible materials. Use appropriate PPE.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A common chemical used to soften water and keep solids dispersed in liquids. Used in water treatment, food processing, ceramics, and detergents.",
    ...
    safety_notes:
      "Can irritate skin and eyes. Use gloves and eye protection. Use in well-ventilated areas. Store in a dry place away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A solution commonly used as a disinfectant and bleach. Effective for sanitizing surfaces, purifying water, and removing stains.",
    ...
    safety_notes:
      "Can cause mild to moderate irritation. Wear gloves and protective eyewear. Use in a well-ventilated area. Avoid contact with acids, ammonia, and organic materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A high-purity white powder used as a preservative, antioxidant, and reducing agent in food, water treatment, and industry.",
    cas_number: "10102-40-6",
    form: "White powder",
    odor: "None",
    solubility: "High",
    ...
    safety_notes:
      "Use in a well-ventilated place. Wear gloves and eye protection. Avoid inhaling dust. Store in a cool, dry place away from acids and oxidisers.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A crystalline compound used as a molybdenum source and corrosion inhibitor in various industrial applications.",
    cas_number: "10102-40-6",
    ...
    safety_notes:
      "Wear gloves and eye protection. Work in well-ventilated area. Store in a cool, dry place away from strong acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A concentrated aqueous solution of sodium silicate used in adhesives, detergents, and water treatment. Acts as a binding and protective agent.",
    ...
    safety_notes:
      "Wear gloves, goggles, and protective gear. Work in well-ventilated area. Store in a cool, dry place away from acids (reacts and gives off heat).",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Solvents",
    description:
      "A high-flash aromatic hydrocarbon solvent used in paints, adhesives, cleaning products, and degreasers. Strong solvency with low odour.",
    ...
    packaging: ["Drums", "IBCs", "Bulk"],
    safety_notes:
      "Flammable (but high flash point). Wear gloves, goggles, and protective gear. Work in well-ventilated space. Store in a cool, dry place away from heat and flames.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Cleaners",
    description:
      "An aqueous solution of sulfamic acid used as a descaling agent and cleaner. Effective at removing limescale, rust, and other mineral deposits.",
    ...
    safety_notes:
      "Use gloves and eye protection. Use in well-ventilated area. Don't mix with strong oxidisers or chlorine-based products.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A concentrated aqueous solution of THPS, an environmentally friendly biocide used in water treatment, oil and gas operations, and papermaking. Also functions as a flame retardant.",
    ...
    safety_notes:
      "Can cause severe irritation or burns. Wear chemical-resistant gloves and safety goggles. Use with good ventilation. Store in a cool, dry place away from incompatible materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A white, crystalline salt used as a food additive, detergent, and in water treatment. Acts as a buffering agent and sequestrant.",
    ...
    safety_notes:
      "Can mildly irritate skin and eyes. Wear PPE. Avoid inhaling dust. Store in a dry, cool place away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A colorless, odorless, and hygroscopic liquid used as a solvent, in antifreeze formulations, and for gas dehydration.",
    cas_number: "112-27-6",
    chemical_formula: "C₆H₁₄O₄",
    appearance: "Clear, colourless liquid",
    ...
    packaging: ["Drums", "IBCs", "Bulk"],
    safety_notes:
      "Wear gloves and goggles. Work in well-ventilated space. Store in a cool, dry place away from oxidisers. Low toxicity but not for consumption.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Cleaners",
    description:
      "A highly concentrated, crystalline salt used as a cleaning agent, pH regulator, and in various industrial processes. Effective in degreasing and cleaning applications.",
    cas_number: "7601-54-9",
    purity: "98%",
    appearance: "White powder",
    odor: "None",
    ...
    packaging: ["25kg bags", "Bulk"],
    safety_notes:
      "Can irritate skin and eyes. Wear gloves, goggles, and protective clothing. Work in ventilated area. Store in a dry, cool place away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A colorless, crystalline compound used in fertilizers, pharmaceuticals, and cosmetics. Contains about 46% nitrogen, making it one of the strongest solid nitrogen fertilisers.",
    cas_number: "57-13-6",
    ...
    safety_notes:
      "Store in a cool, dry spot with good airflow. Avoid moisture and direct sunlight. Wear gloves and eye protection when handling dusty material.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Fertilizers and Industrial Chemicals",
    description:
      "Concentrated aqueous solutions of urea in 20% and 50% concentrations. Used in agriculture, medicine, cosmetics, and water treatment.",
    cas_number: "57-13-6",
    ...
    safety_notes:
      "Store in a cool, dry place out of direct sunlight. Generally safe but avoid ingestion and eye contact.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Solvents",
    description:
      "A mixture of three related aromatic hydrocarbons: ortho-xylene, meta-xylene, and para-xylene. Used as solvents in industrial applications, paint thinners, and chemical synthesis.",
    ...
    safety_notes:
      "Flammable. Use in well-ventilated spaces with gloves, goggles, and protective clothing. Store in sealed containers away from heat or flames.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Cleaners",
    description:
      "A highly concentrated, solid acid used as a descaling agent and in various industrial applications. Effective in removing mineral deposits and used in chemical synthesis.",
    cas_number: "5329-14-6",
    purity: "100%",
    ...
    safety_notes:
      "Wear gloves, goggles, and protective clothing. Work in well-ventilated area. Store in a cool, dry place away from moisture and strong chemicals.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Disinfectants and Bleach",
    description:
      "Solutions in 5% and 12.5% concentrations used as disinfectants and bleach. Effective for sanitizing surfaces, purifying water, and removing stains.",
    cas_number: "7681-52-9",
    ...
    safety_notes:
      "Corrosive. Store in a cool place away from sunlight. Use appropriate PPE. Avoid contact with acids, ammonia, and organic materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A concentrated aqueous solution of sodium chlorite used as a powerful oxidizing agent and disinfectant. Used in water treatment, textile bleaching, and chlorine dioxide production.",
    ...
    safety_notes:
      "Can irritate. Wear gloves, eye protection, and protective clothing. Store in a cool, ventilated space away from heat, acids, and organic materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-strength reducing agent used for oxygen removal in boiler water treatment, oilfield applications, and industrial preservation.",
    ...
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Corrosive. Store in a cool, dry, ventilated area away from oxidizers. Use gloves and eye protection.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A versatile chemical solution used for oxygen scavenging, corrosion control, and preservation of pipelines and equipment.",
    ...
    packaging: ["Customizable options"],
    safety_notes:
      "Can corrode metal surfaces over time. Use gloves and goggles. Ensure good ventilation. Keep away from strong oxidizers and acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A high-purity oxygen scavenger formulated for aggressive corrosion control in critical industrial systems. Reacts rapidly with dissolved oxygen.",
    cas_number: "10102-43-9",
    concentration: "60%",
    chemical_formula: "NH₄HSO₃",
    appearance: "Pale yellow liquid",
    ...
    safety_notes:
      "May irritate skin or respiratory system. Store in a cool, dry, ventilated area away from oxidising agents and acids. Use PPE.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A lower-concentration solution used in water treatment, paper bleaching, and food preservation. Serves as an efficient oxygen scavenger for moderate-duty corrosion control.",
    cas_number: "10102-43-9",
    concentration: "40%",
    appearance: "Pale yellow liquid",
    odor: "Mild sulphurous",
    ...
    safety_notes:
      "May cause irritation on contact. Use PPE. Store in a cool, dry, ventilated space away from oxidising agents.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A high-purity additive used in the food and beverage industry as a preservative and antioxidant. Effective in preventing microbial growth and maintaining product freshness.",
    cas_number: "10192-30-0",
    appearance: "Clear to slightly yellow liquid",
    ...
    safety_notes:
      "Approved for controlled food use. Low risk of skin and eye irritation. Do not mix with strong oxidizers. Store in a clean, dry location.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A clear, water-soluble liquid used in pulp and paper bleaching, photographic development, and as a reducing agent in various industrial processes.",
    ...
    packaging: ["Drums", "IBCs", "Tankers"],
    safety_notes:
      "May irritate skin and eyes. Use PPE. Store in a cool, ventilated area away from oxidising materials.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A clear, sulfur-based liquid used in water treatment, pulp bleaching, and as an effective oxygen scavenger in boiler feedwater systems.",
    cas_number: "10192-30-0",
    appearance: "Pale yellow liquid",
    ...
    packaging: ["Drums", "IBCs", "Bulk"],
    safety_notes:
      "Store in a cool, well-ventilated environment away from heat sources and oxidizers. Use gloves and eye protection.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    description:
      "A specialized formulation used in metal finishing, electroplating, and catalyst applications. Integrates nickel ions with the reducing power of bisulphite.",
    ...
    packaging: ["Customizable options"],
    safety_notes:
      "May cause irritation or allergic reaction due to nickel. Toxic if ingested. Avoid mixing with oxidizers, acids, and incompatible metals. Store in a cool, well-ventilated facility.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Specialty Industrial Chemicals",
    description:
      "A specialized chemical solution containing cobalt ions, designed for applications in catalyst systems, electronics, and electroplating. Offers enhanced redox performance.",
    cas_number: "10102-40-6",
    ...
    safety_notes:
      "Use in ventilated areas. Avoid inhalation and skin contact. Use appropriate PPE. Store away from acids.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "Versatile and highly corrosive liquids available in 60%, 93%, and 98% concentrations. Used in fertilizer production, chemical manufacturing, petroleum refining, metal processing, and water treatment.",
    ...
    concentration_60_percent: {
      ...
      characteristics:
        "Easier to handle than stronger acids, clear or light yellow, syrupy",
    },
    concentration_93_percent: {
      uses: ["Fertiliser production", "Oil refining", "Battery acid"],
      characteristics:
        "Standard for most industrial uses, strong but manageable",
    },
    concentration_98_percent: {
      uses: ["Chemical manufacturing", "Explosives", "Laboratories"],
      characteristics:
        "Strongest and purest, very little water, heavy oily feel",
    },
    packaging: ["Drums", "IBCs", "Bulk tankers"],
    safety_notes:
      "Highly corrosive. Wear proper safety gear. Avoid contact with metals and organic materials. Store in acid-safe containers in a cool, dry area.",
    supplier: "Pascom",
    country: "Australia",
  },
  {
    ...
    category: "Industrial Chemicals",
    description:
      "A chemical used in water treatment, electronics, and metal processing. Available in 40% and 42% solutions.",
    ...
    safety_notes:
      "Corrosive. Store in a cool, well-ventilated place. Wear protective gear. Delivery across Australia.",
    supplier: "Pascom",
    country: "Australia",
  },
];
