...
export default function SDSRequestPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Request submitted successfully! We will email the SDS to your address shortly.",
    );
  ...
  return (
    <section
      className="min-h-screen py-32 px-4 md:px-8 lg:px-16 font-sans antialiased"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          ...
          >
            Request{" "}
            <span style={{ color: "rgba(255, 255, 255, 0.9)" }}>SDS</span>
          </h1>
          <p
            className="text-lg max-w-2xl"
            style={{ color: "rgba(255, 255, 255, 0.8)" }}
          >
            Request Safety Data Sheets for our chemical products. Fill out the
            form below and we&apos;ll send the SDS to your email.
          </p>
        </div>
          ...
          <div className="lg:col-span-1 space-y-8">
            <div className="p-8">
              ...
              >
                <li className="flex items-start gap-3">
                  <span
                    className="font-bold w-6 h-6 rounded-full flex items-center justify-center shrink-0 text-xs mt-0.5"
                    style={{
                      backgroundColor: "var(--color-primary-red)",
                      color: "var(--color-white)",
                    }}
            ...
            <div className="p-8">
              ...
              <p
                ...
                style={{ color: "rgba(255, 255, 255, 0.8)" }}
              >
                Select &quot;Other Product&quot; from the list and provide the
                product name in the details section below.
              </p>
            </div>
