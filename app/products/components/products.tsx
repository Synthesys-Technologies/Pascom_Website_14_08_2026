...
// The full list of 69 chemical products provided
const productsList = [
  {
    "id": "acetic-acid-90",
    "name": "Acetic Acid 90%",
...
export default function ProductsPage() {
  ...
  return (
    <main className="min-h-screen bg-white font-sans text-gray-900 antialiased overflow-x-hidden">
      {/* =========================================
          HERO SECTION (Replicating Reference Image)
          ========================================= */}
      <section className="pt-24 pb-16 px-4 flex flex-col items-center text-center w-full">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold max-w-5xl leading-[1.15] tracking-tight text-gray-900 mb-6">
          Pascom supplies high quality chemicals for the oil & gas, water
          treatment, agriculture, and mining industries.
        </h1>
        <p className="text-gray-500 text-base md:text-lg max-w-2xl mb-8 font-medium">
          Focusing on innovative, reliable, and efficient solutions tailored to
          meet the highest industry standards.
        </p>

        {/* Button */}
        <button className="flex items-center gap-3 bg-white border border-gray-200 rounded-full pl-6 pr-2 py-2 shadow-sm hover:shadow-md transition-all duration-300 mb-20 group">
          <span className="text-sm font-bold text-gray-800">
            View Full Catalog
          </span>
          <div className="w-8 h-8 rounded-full bg-[#DC2626] flex items-center justify-center text-white group-hover:scale-105 transition-transform">
            <i className="fa-solid fa-arrow-right text-xs"></i>
          </div>
        </button>

        {/* 3D Curved Image Gallery */}
        <div className="relative w-full max-w-[1400px] h-[300px] md:h-[400px] flex justify-center items-center perspective-[1200px] mb-12">
          {/* Card 1 (Far Left) */}
          <div
            className="absolute w-[20%] h-[80%] rounded-2xl overflow-hidden shadow-2xl transition-transform duration-500"
            style={{
              transform:
                "rotateY(35deg) translateZ(-200px) translateX(-180%) scaleY(1.1)",
            }}
          >
            <img
          ...
          <div
            ...
            style={{
              transform:
                "rotateY(20deg) translateZ(-100px) translateX(-90%) scaleY(1.05)",
            }}
          >
            <img
              src="https://images.unsplash.com/photo-1543419992-628d052ceba4?q=80&w=600&auto=format&fit=crop"
              alt="Water Treatment"
              className="w-full h-full object-cover"
            />
          </div>
          ...
          {/* Card 3 (Center - Focus) */}
          <div
            className="absolute w-[25%] h-[90%] rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)] z-10 transition-transform duration-500 hover:scale-105 cursor-pointer"
            style={{
        ...
        {/* Gallery Labels (Matching Reference Image) */}
        <div className="hidden md:flex justify-center gap-16 lg:gap-32 w-full max-w-5xl mt-8">
          <div className="text-center">
            <span className="text-[#DC2626] font-bold text-sm block mb-1">
              #01
            </span>
      ...
      {/* =========================================
          ...
          ========================================= */}
      <section className="bg-[#F8FAFC] py-24 px-4 border-y border-gray-100">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-medium">
            <p>
              ...
              gas, water treatment, agriculture, and mining sectors. Our deep
              understanding of the unique requirements in these industries
              enables us to deliver products and services that meet the highest
          ...
          <div className="space-y-6 text-gray-600 text-lg leading-relaxed font-medium">
            <p>
              ...
              adherence to the ISO 9001:2015 management system. These
              credentials are acknowledged by our clients and the regulatory
              bodies that govern the industries we serve.
            </p>
            <p>
              ...
              knowing that their specific requirements are fully addressed by a
              partner who understands the intricacies of their industry.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* =========================================
          69 PRODUCT CARDS GRID
          ========================================= */}
      <section className="py-24 px-4 max-w-350 mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">
            Comprehensive Product Catalog
          </h2>
          {/* Search Bar for the massive list */}
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-full pl-10 pr-4 py-3 outline-none focus:border-[#DC2626] focus:ring-1 focus:ring-[#DC2626] transition-all"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product, index) => (
              <div
                key={index}
                className="group bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_8px_30px_rgba(0,0,0,0.12)] hover:border-[#DC2626]/30 transition-all duration-300 flex flex-col h-full"
              >
                {/* Image Container */}
                <div className="relative overflow-hidden bg-linear-to-br from-red-50 to-red-100 h-48">
                  <Image
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex-1">
                    {/* Icon - Now smaller and positioned differently */}
                    <div className="w-10 h-10 rounded-full bg-orange-50 text-[#DC2626] flex items-center justify-center mb-3 border border-orange-100/50 shadow-sm">
                      <i className="fa-solid fa-flask text-sm"></i>
                    </div>

                    <h3 className="font-bold text-gray-900 leading-snug group-hover:text-[#DC2626] transition-colors text-lg mb-2">
                      {product.name}
                    </h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
                    <a
                      href="#"
                      className="inline-flex items-center gap-2 text-xs font-bold text-gray-500 uppercase tracking-widest group-hover:text-gray-900 transition-colors"
                    >
                      View Details
                      <i className="fa-solid fa-arrow-right-long text-[#DC2626] transform group-hover:translate-x-1 transition-transform"></i>
                    </a>

                    {/* Optional Price or Tag */}
                    <span className="text-xs font-semibold text-[#DC2626] bg-orange-50 px-3 py-1 rounded-full">
                      Inquire
                    </span>
                  </div>
                </div>
